                ...
                foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                    ...
                    if (((($context["keyName"] == "Налоги и сборы") || ($context["keyName"] == "Гонорары")) || ($context["keyName"] == "Прибыль"))) {
                        ...
                        echo "
                            ...
                            <td class=\"";
                        // line 616
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "balanceColor", [], "any", false, false, false, 616), "html", null, true);
                        echo "\">
                                ";
                        // line 617
